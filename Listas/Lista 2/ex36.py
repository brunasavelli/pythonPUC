...
atrasar o horário digitado a quantidade de segundo também digitada.
'''
                ...
                try:
                    ...
                    if segundos < 0 or segundos > 59:
                        ...
                        try:
                            ...
                            adSegundos = int(input("Adicione os segundos para serem atrasados: "))
                        except ValueError:
                            print("Os segundos devem ser numéricos.")
                        else:
                            if adSegundos <= 0:
